...
{
      14,     0,    -1,    14,    15,    -1,    -1,    16,    10,    -1,
      16,     6,    16,    -1,    16,     7,    16,    -1,    16,     8,
      16,    -1,    16,     9,    16,    -1,    11,    16,    12,    -1,
       3,     5,    16,    -1,     3,    -1,     4,    -1
};
...
{
  "$end", "error", "$undefined", "IDEN", "NUM", "'='", "'+'", "'-'",
  "'*'", "'/'", "'\\n'", "'('", "')'", "$accept", "STMTS", "ST", "EXP", 0
};
#endif
...
{
      -5,     0,    -5,    -4,    -5,     9,    -5,    17,     9,    10,
       9,     9,     9,     9,    -5,    22,    -5,     6,     6,    -5,
      -5
};
...
{
       2,     8,     9,     3,     4,    15,     0,    17,    18,    19,
      20,     5,     3,     4,    12,    13,    10,    11,    12,    13,
       5,     0,    16,    10,    11,    12,    13,    14,    10,    11,
      12,    13
};

static const yytype_int8 yycheck[] =
{
       0,     5,     5,     3,     4,     8,    -1,    10,    11,    12,
      13,    11,     3,     4,     8,     9,     6,     7,     8,     9,
      11,    -1,    12,     6,     7,     8,     9,    10,     6,     7,
       8,     9
};
...
{
       0,    14,     0,     3,     4,    11,    15,    16,     5,    16,
       6,     7,     8,     9,    10,    16,    12,    16,    16,    16,
      16
};
...
void triples() {
    for(int i=0;i<=idx;i++) {
        if(code[i].op == ' ') {
            ...
            printf("%d: %c %s %s\n", i, code[i].op, code[i].op1, code[i].op2);
        }
    }
}
